---
title: "R Masterclass | Week 5 Workshop"
...
Welcome to the second week of data manipulation! In this workshop, you'll be working with a dataset on HIV cases to write functions and use loops effectively in R.
...
In this step, you will write a function that checks if there are any missing values in the HIV dataset. This function should take a data frame (`data`) as an argument and return a message indicating whether there are missing values or not.
