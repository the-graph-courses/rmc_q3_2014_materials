...
**CHECKPOINT:** Verify that the dataset is correctly joined and ready for visualization. Your dataset should have **54 rows and 14 columns**.
...
## Challenge 1: Joining & Filtering

Create a choropleth map showing the total COVID-19 deaths for only the countries in **Western Africa**.

```{r}
"WRITE_YOUR_CODE_HERE"
```

## Challenge 2: Per Capita Cases
