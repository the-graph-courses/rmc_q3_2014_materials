...
Thus, three datasets were produced. Refer to the meta data file "yaounde_data_description.Rmd" in the data folder for variable definitions as you complete the exercise.
